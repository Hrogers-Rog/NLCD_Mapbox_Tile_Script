...
def package_documents(
    ...
    map_document = {
        "origin": {
            ...
            "eastBiasMeters": profile.origin_east_bias_meters,
            "northBiasMeters": profile.origin_north_bias_meters,
        },
    ...
    fuse_document = {
        ...
        "map": {
            ...
            or f"DEM-calibrated terrain for {display_name} with base Bushnell content suppressed.",
            "mapFolder": "Map",
...
def main() -> int:
    ...
    attribution_path = package_root / "ATTRIBUTION.txt"
    if not attribution_path.exists():
        attribution_path.write_text(
            "Railway geometry © OpenStreetMap contributors.\n"
            "OpenStreetMap data is available under the Open Database License (ODbL) 1.0.\n"
            "https://www.openstreetmap.org/copyright\n"
            "\n"
            "Elevation data: Mapbox Terrain-RGB.\n"
            "Land cover: U.S. Geological Survey NLCD 2021 via MRLC.\n",
            encoding="utf-8",
        )
